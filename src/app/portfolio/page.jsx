    ...
    return (
        ...
        >
            <div className="h-[600vh] relative" ref={ref}>
                <div className="w-screen h-[calc(100vh-6rem)] flex flex-col gap-20 text-2xl font-bold md:text-4xl lg:text-5xl xl:text-7xl items-center justify-center text-center">
                    <h1>
                        HUYEN@PROJECTS
                    </h1>
